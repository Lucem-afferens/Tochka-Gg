...
// Получаем данные со страницы VR арены (поля настраиваются для конкретной страницы)
...
$vr_image = get_field('vr_image'); // Изображение со страницы

// Дополнительные данные со страницы
