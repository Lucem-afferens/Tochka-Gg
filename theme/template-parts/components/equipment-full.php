...
<section class="tgg-equipment-full">
    <div class="tgg-container">
        ...
        <!-- Мониторы -->
        <div class="tgg-equipment-full__category">
            <h2 class="tgg-equipment-full__category-title">Мониторы</h2>
            <div class="tgg-equipment-full__specs">
                <div class="tgg-equipment-full__spec-item">
                    <div class="tgg-equipment-full__spec-label">Модель</div>
                    <div class="tgg-equipment-full__spec-value">Titan Army 24.5"</div>
                </div>
                
                <div class="tgg-equipment-full__spec-item">
                    <div class="tgg-equipment-full__spec-label">Частота обновления</div>
                    <div class="tgg-equipment-full__spec-value">240 Гц</div>
                </div>
                
                <div class="tgg-equipment-full__spec-item">
                    <div class="tgg-equipment-full__spec-label">Применение</div>
                    <div class="tgg-equipment-full__spec-value">LITE и VIP категории</div>
                </div>
            </div>
        </div>
        ...
        <div class="tgg-equipment-full__category" id="ps5">
            ...
            <div class="tgg-equipment-full__specs">
                <div class="tgg-equipment-full__spec-item">
                    <div class="tgg-equipment-full__spec-label">Количество</div>
                ...
                <div class="tgg-equipment-full__spec-item">
                    <div class="tgg-equipment-full__spec-label">Игры</div>
                    <div class="tgg-equipment-full__spec-value">Более 50 игр</div>
                </div>
            ...
            <div class="tgg-equipment-full__description">
                <p>Давно мечтаешь погонять в новинки на PS5? Лови момент — у нас уже стоит одна красавица, ждущая, чтобы ты взял в руки геймпад! Больше 50 игр, плюс крутые тайтлы из подписки PS Plus. Остальные приставки уже в пути — так что торопись занять место у экрана!</p>
            </div>
        </div>
    </div>
</section>
